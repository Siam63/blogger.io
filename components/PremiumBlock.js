    ...
    return (
        <div>
            <div className="py-5 flex justify-center">
                <div class="w-64 p-4 bg-white shadow-xl rounded-2xl dark:bg-gray-800">
                ...
                <div class="ml-10 w-64 p-4 bg-white shadow-xl rounded-2xl dark:bg-gray-800">
                    <p class="text-center text-xl font-medium text-gray-800 dark:text-gray-50">
                        Entry Access
                    </p>
                    <p class="text-center text-3xl font-bold text-gray-900 dark:text-white">
